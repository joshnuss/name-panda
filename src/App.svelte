...
<Equation title="Suffix" summary="Append a suffix to the name." bind:a={name} bind:b={ending} labelA="Name" labelB="Ending" formula={(a, b) => `${a}${b}`} showRefresh="b" on:refresh={refreshEnding}/>

<Equation title="Prefix" summary="Prepend a prefix to the name." bind:a={prefix} bind:b={name} labelA="Prefix" labelB="Name" formula={(a, b) => `${a}${b}`} showRefresh="a" on:refresh={refreshPrefix}/>
